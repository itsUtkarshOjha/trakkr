...
// import { getPastAnalyses } from "~/controllers/workoutAnalysis.controller";
...
//   if (!workoutId) return redirect("/ai-analysis");
//   const pastAnalyses = await getPastAnalyses(workoutId, user!.id);
//   if (!pastAnalyses) return redirect("/ai-analysis");
//   const latestAnalysis = pastAnalyses[0];
//   console.log(latestAnalysis);
//   return { pastAnalyses, latestAnalysis };
// };

// export default function AIAnalysisWorkout() {
//   const loaderData: {
//     pastAnalyses: WorkoutAnalysis[];
//     latestAnalysis: WorkoutAnalysis;
//   } = useLoaderData<typeof loader>();
//   const { pastAnalyses, latestAnalysis } = loaderData;
//   return (
...
//       />
//       <div className="grid grid-cols-5 grid-rows-4 gap-8 mt-12">
...
//         </div>
//         <div className="col-span-1 row-span-3 bg-primary-foreground rounded-xl">
...
//               <h4 className="uppercase tracking-wider text-[12px] font-extralight text-right">
//                 Calories Burnt
//               </h4>
...
export default function AIAnalysisWorkout() {
  return (
    <div className="w-full">
      ...
      <HeadingSubheading
        heading="AI Analysis (paused)"
        subheading="This feature is currently paused. The following is just a placeholder data."
      />
